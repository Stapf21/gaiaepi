...
class SystemSettingRepository
{
    ...
    public static function branding(): array
    {
        ...
        $logoUrlSetting = trim((string) ($settings['branding.logo_url'] ?? ''));
        $faviconPath = $settings['branding.favicon_path'] ?? null;
        $faviconUrlSetting = trim((string) ($settings['branding.favicon_url'] ?? ''));
        ...
        $loginOverlayGifPath = $settings['branding.login_overlay_gif_path'] ?? null;
        $loginOverlayGifUrlSetting = trim((string) ($settings['branding.login_overlay_gif_url'] ?? ''));
        ...
        return [
            'logo_path' => $logoPath,
            'logo_url' => $logoUrlSetting !== '' ? $logoUrlSetting : ($logoPath ? '/storage/'.$logoPath : null),
            'favicon_path' => $faviconPath,
            'favicon_url' => $faviconUrlSetting !== '' ? $faviconUrlSetting : ($faviconPath ? '/storage/'.$faviconPath : null),
            ...
            'login_overlay_gif_path' => $loginOverlayGifPath,
            'login_overlay_gif_url' => $loginOverlayGifUrlSetting !== '' ? $loginOverlayGifUrlSetting : ($loginOverlayGifPath ? '/storage/'.$loginOverlayGifPath : null),
        ];
    }
}
